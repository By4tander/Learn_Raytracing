...
/*******交散模糊，也就是“景深”depth of field****
* We call the distance between the projection point and the plane
*where everything is in perfect focus the ⚠️focus distance.
*Be aware that the focus distance is not the same as the
*⚠️focal length — the distance between the projection point and the image plane.
*/
...
int main() {
    ...
    // Render
    std::ofstream  ofs("11Defocus_Blur.ppm",std::ios::binary);
